...
const DEFAULT_FEATURES = {
  ...
  feature1Description:
    'Generate professional invoices in under 30 seconds with smart templates, auto-fill client data, and customizable branding.',
  feature1Badge: 'Speed',
  feature2Title: 'Bank-Level Security & Compliance',
  feature2Description:
    'Your financial data is protected with 256-bit encryption, PCI DSS compliance, and secure cloud infrastructure.',
  feature2Badge: 'Security',
  feature3Title: 'Mobile Invoice Management',
  feature3Description:
    'Create, send, and track invoices on-the-go with our native mobile apps for iOS and Android.',
  feature3Badge: 'Mobile',
  feature4Title: 'Multi-Currency & Global Payments',
  feature4Description:
    'Accept payments in 130+ currencies with automatic tax calculations and international payment processing.',
  feature4Badge: 'Global',
  feature5Title: 'Advanced Financial Reporting',
  feature5Description:
    'Track cash flow, payment trends, and client analytics with real-time dashboards and automated reports.',
  feature5Badge: 'Analytics',
  feature6Title: 'Smart Payment Automation',
  feature6Description:
    'Set up automatic payment reminders, recurring invoices, and late fee calculations to improve cash flow.',
  feature6Badge: 'Automation',
  feature7Title: 'Seamless Integrations',
  feature7Description:
    'Connect with QuickBooks, Xero, Stripe, PayPal, and 50+ other business tools via our robust API.',
  feature7Badge: 'Integration',
  feature8Title: 'Expert Customer Success',
  feature8Description:
    'Get personalized onboarding, live chat support, and dedicated account management for enterprise clients.',
  feature8Badge: 'Support',
  feature9Title: 'Data Privacy & Backup',
  feature9Description:
    'Your invoices and client data are automatically backed up daily with GDPR compliance and data portability.',
