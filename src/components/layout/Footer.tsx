...
const DEFAULT_FOOTER = {
  ...
  newsletterDisclaimer:
    'Join our newsletter for exclusive insights and updates. Unsubscribe anytime.',
  ...
  const footerSections = [
    {
      ...
      links: [
        ...
        },
        {
          name: 'Brand Strategy',
          href: '/brand-strategy',
          editableId: 'link-footer-brand-strategy',
        },
        ...
        { name: 'Consulting', href: '/consulting', editableId: 'link-footer-consulting' },
        {
          ...
          editableId: 'link-footer-custom-solutions',
        },
      ],
    },
    {
      ...
      links: [
        ...
        { name: 'Get In Touch', href: '/contact', editableId: 'link-footer-contact' },
      ],
    },
    {
      ...
      links: [
        ...
        { name: 'Client Portal', href: '/client-portal', editableId: 'link-footer-client-portal' },
        { name: 'Training Center', href: '/training', editableId: 'link-footer-training' },
        { name: 'Live Chat Support', href: '/support', editableId: 'link-footer-support' },
